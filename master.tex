...
%\usepackage[capposition=top]{floatrow} %for notes and figures
...
\setlength{\footnotesep}{4pt}  % vertical space between footnotes
...
leftmargin=0.5cm,rightmargin=0.5cm,skipabove=0.5cm,skipbelow=1cm,innertopmargin=0.5cm,innerbottommargin=0.5cm,innerleftmargin=0.5cm, innerrightmargin=0.5cm
}
...
\begin{figure}[htp]
	\centering
		\input{input/testfigure.tex} % change path to output/ and adjust filename accordingly
...
\begin{center}
	\resizebox{\linewidth}{!}{ % resize the table to match the line width - adjust if necessary
		\input{input/testtable.tex} % change path to output/ and adjust filename accordingly
	}
\end{center}
